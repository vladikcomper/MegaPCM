...
void runTest(
	...
	EmulatedPlaybackState playbackState = {
		...
		.pos = 0,
		.length = sampleSize * (((sampleType == Z_MPCM_TYPE_DPCM) || (sampleType == Z_MPCM_TYPE_DPCM_TURBO)) ? 2 : 1),
		.pitch = pitch,
		.pitchCounter = 0,
...
int main(int argc, char * argv[]) {
	...
	/* No-bankswitching */
	runTest(context, Z_MPCM_TYPE_PCM, sample_pcm_2, sample_pcm_2, sizeof(sample_pcm_2), 0);
	runTest(context, Z_MPCM_TYPE_PCM, sample_pcm_8, sample_pcm_8, sizeof(sample_pcm_8), 0);
	runTest(context, Z_MPCM_TYPE_PCM, sample_pcm_254, sample_pcm_254, sizeof(sample_pcm_254), 0);
	runTest(context, Z_MPCM_TYPE_PCM_TURBO, sample_pcm_2, sample_pcm_2, sizeof(sample_pcm_2), 0);
	runTest(context, Z_MPCM_TYPE_PCM_TURBO, sample_pcm_8, sample_pcm_8, sizeof(sample_pcm_8), 0);
	...
	/* With bankswitching */
	runTest(context, Z_MPCM_TYPE_PCM, sample_pcm_2, sample_pcm_2, sizeof(sample_pcm_2), 0x7FFE);
	runTest(context, Z_MPCM_TYPE_PCM, sample_pcm_8, sample_pcm_8, sizeof(sample_pcm_8), 0x7FFE);
	runTest(context, Z_MPCM_TYPE_PCM, sample_pcm_254, sample_pcm_254, sizeof(sample_pcm_254), 0x7FFE);
	runTest(context, Z_MPCM_TYPE_PCM_TURBO, sample_pcm_2, sample_pcm_2, sizeof(sample_pcm_2), 0x7FFE);
	runTest(context, Z_MPCM_TYPE_PCM_TURBO, sample_pcm_8, sample_pcm_8, sizeof(sample_pcm_8), 0x7FFE);
