...
Here's a minimal Mega PCM 2 example which demonstrates most of API calls. MD Shell's `Console.Sleep` macro is used here to demonstrate skipping frames during playback.
