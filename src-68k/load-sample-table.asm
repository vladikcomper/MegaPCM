...
MegaPCM_LoadSampleTable:
	...
	moveq	#$80-1, @sample_cnt			; load at most $80 samples (but table should have an end marker anyways!)
...
@Quit:	lea	-$C(@sample_tbl), @sample_tbl		; seek the start of sample record (helps to investiage erros, if any)
